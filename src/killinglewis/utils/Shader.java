...
public class Shader {
    ...
    public Shader(String vertexPath, String fragmentPath) {
        ...
        enable();
        //Matrix4f PROJECTION_MATRIX = Matrix4f.getProjectionMatrix(30, 16.0f/9.0f, 1.0f, -10.0f);
        this.setUniformMat4f("projection_matrix", PROJECTION_MATRIX);
    ...
    public void loadModelViewMatrix (Matrix4f modelViewMatrix) {
        setUniformMat4f("modelViewMatrix", modelViewMatrix);
    }
